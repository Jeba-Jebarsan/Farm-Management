      ...
      {showForm && isAdmin && (
        <div className="card-gov p-0 mb-6 animate-slide-down">
          ...
          <div className="p-4 md:p-8 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-4 md:space-x-6 pb-4 border-b border-slate-100 dark:border-slate-700">
            ...
            <form onSubmit={handleSubmitEmployee} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
              <div>
      ...
      {showForm && isAdmin && (
        <div className="card-gov p-0 mb-6 animate-slide-down">
          ...
          <div className="p-4 md:p-8 space-y-6">
            ...
            <form onSubmit={handleSubmitLeave} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
              <div>
      ...
      {showForm && isAdmin && (
        <div className="card-gov p-0 mb-6 animate-slide-down">
          ...
          <div className="p-4 md:p-8 space-y-6">
            ...
            <form onSubmit={handleSubmitOvertime} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
              <div>
      ...
      <div className="flex flex-wrap gap-1 bg-white dark:bg-slate-800 p-1.5 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
        {SUB_TABS.map(tab => (
          <button
            ...
            className={`flex-1 px-2 md:px-4 py-2 md:py-2.5 rounded-lg text-xs md:text-[13px] font-heading font-bold transition-all ${
              activeSubTab === tab
