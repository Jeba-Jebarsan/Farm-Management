        ...
        <div className="card-gov overflow-hidden">
          <div className="overflow-x-auto">
            <table className="table-gov w-full">
              <thead>
                <tr>
                  <th className="px-6 py-4 text-left">Inventory No.</th>
                  ...
                  <th className="px-6 py-4 text-left">Custody</th>
                  ...
                  filteredData
                    ...
                    .map(item => (
                      <tr key={item.id} className="hover:bg-brand-50/50 transition-colors">
                        <td className="px-6 py-4 font-medium text-brand-700">{item.inventoryNumber}</td>
                        ...
                        <td className="px-6 py-4 text-gray-600">{item.dateOfPurchase}</td>
                        <td className="px-6 py-4 text-right font-semibold text-gray-900">₨ {fmt(item.value)}</td>
                        ...
                        <td className="px-6 py-4 text-gray-600">{item.custody || '—'}</td>
                        {isAdmin && (
                          <td className="px-6 py-4">
