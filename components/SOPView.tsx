    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
      <div className="space-y-6">
        <div className="bg-white p-4 md:p-8 rounded-3xl border border-slate-200 shadow-sm">
          <h3 className="text-base md:text-lg font-extrabold text-slate-800 mb-4 md:mb-6 flex items-center">
        ...
        <div className="bg-slate-900 p-4 md:p-8 rounded-3xl text-white shadow-xl shadow-slate-200 relative overflow-hidden">
          <ShieldCheck className="absolute -right-8 -bottom-8 text-white/5" size={160} />
          <h3 className="text-lg md:text-xl font-extrabold mb-3 flex items-center relative z-10">
      ...
      <div className="space-y-6">
        <div className="bg-white p-4 md:p-8 rounded-3xl border border-slate-200 shadow-sm flex flex-col h-full">
          <h3 className="text-base md:text-lg font-extrabold text-slate-800 mb-4 md:mb-6 flex items-center">
