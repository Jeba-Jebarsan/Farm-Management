  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
          <h4 className="font-bold text-slate-800 mb-6">Top Vehicle Expenses</h4>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              ...
              {vehicleStats.map(stat => {
                ...
                return (
                  <tr key={stat.id} className="hover:bg-slate-800/50">
                    <td className="px-6 py-4 font-bold text-white">{stat.id}</td>
                    <td className="px-6 py-4">Rs. {fuel.toLocaleString()}</td>
                    <td className="px-6 py-4">Rs. {maint.toLocaleString()}</td>
                    <td className="px-6 py-4">Rs. {repr.toLocaleString()}</td>
                    <td className="px-6 py-4">Rs. {ins.toLocaleString()}</td>
                    <td className="px-6 py-4 font-bold text-blue-400">Rs. {stat.cost.toLocaleString()}</td>
                  </tr>
                );
              })}
            </tbody>
