  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        {isAdmin && (
          <button onClick={handleOpenAdd} className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl flex items-center space-x-2 text-sm font-bold shadow-lg shadow-blue-200">
            <Plus size={18} />
            <span>New Asset</span>
          </button>
        )}
        ...
        <table className="w-full text-left text-sm">
          <thead>
            <tr className="bg-slate-50 border-b border-slate-100 text-slate-500 font-bold uppercase text-[10px] tracking-widest">
              ...
              <th className="px-6 py-4">SL Plate No</th>
