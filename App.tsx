...
const App: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-slate-100 dark:bg-slate-900">
      {/* ======== SIDEBAR ======== */}
      <aside className="w-72 bg-gradient-to-b from-[#003d10] via-[#004a13] to-[#002a0b] text-white flex flex-col hidden md:flex shadow-2xl relative overflow-hidden">
        ...
        {/* Navigation */}
        <nav className="flex-1 mt-2 px-4 space-y-0.5">
        ...
        <div className="mx-4 mb-2">
          <button
            ...
            className="w-full flex items-center space-x-3 px-4 py-2.5 rounded-xl text-green-300/60 hover:text-white hover:bg-white/5 transition-all"
          >
        ...
        {/* User panel */}
        <div className="m-4 mt-2 p-4 rounded-2xl bg-black/20 backdrop-blur-sm border border-white/10">
      ...
      <main className="flex-1 overflow-y-auto bg-slate-50 dark:bg-slate-900">
        ...
        <header className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 px-8 py-4 flex justify-between items-center relative">
          <div>
          ...
          <div className="flex items-center space-x-5">
            ...
            <div className={`px-3 py-1.5 rounded-full text-[9px] font-heading font-bold uppercase tracking-wider border ${
              isAdmin
